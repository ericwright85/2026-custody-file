# Rayan behavior — causation hypotheses

Status: working analytical hypothesis. This file distinguishes **what the evidence proves** from **what may explain it**. It should not be presented as a clinical conclusion without qualified expert support.

## Confirmed new condition

The 2025–26 school records establish a meaningful post-cutoff behavioral/discipline deterioration: repeated tardies/absences, multiple ISS/OSS events, physical altercations, classroom disruption, missing-work concerns, and other conduct issues. The records reviewed so far do **not** establish that the 50/50 schedule caused those problems or that reducing Eric's possession would remedy them.

## Competing causation theories

### Theory A — schedule / Eric-caused deterioration
This is the theory Sana may advance: the current possession structure, Eric's parenting style, or inconsistency between homes is contributing to Rayan's school and behavior problems.

**Current evidentiary weakness:** objective school records establish the behavior problem, but do not yet identify household causation. We still need a custody-day overlay, teacher/counselor observations tied to specific transitions, and any professional opinion linking behavior to either home or to the possession schedule itself.
...
For each alleged home-environment factor, build:

`date → source → exact words/conduct → direct/secondhand → child reaction → neutral corroboration → later behavioral event → alternative explanations`

This will let us test whether there is a repeated longitudinal pattern rather than rely on isolated emotionally charged incidents.
...
- custody-day overlay for tardies, absences, suspensions, and major discipline incidents;
- evidence of Eric's and Sana's respective responses/interventions after school incidents.

## Presentation rule

Do not argue "Sana caused his behavior" as a bare conclusion. The stronger formulation, if the evidence continues to develop this way, is:

> Rayan's later behavioral difficulties are real, but the evidence does not justify attributing them to shared possession or Eric. The broader record shows longstanding emotional conflict and negative parent-child dynamics that provide plausible competing explanations and require neutral evaluation before any possession reduction is treated as a remedy.
